...
\DataTypeTok{print}\NormalTok{(np.arange(}\DecValTok{1}\NormalTok{,}\DecValTok{10}\NormalTok{) * }\DecValTok{3}\NormalTok{)}
...
Now some $\alpha$ inline $\beta$ math $\gamma$ with $\delta$ lot $\eta$
of $\zeta$ Greek.
